...
> {
    static Vec8d compute(Vec8d PA, Vec8d PB, Vec8d p) {
        // A-side t>0
        // CSE: Cache recursive calls
        Vec8d e_0 = HermiteECoeff<nA - 1, nB, t - 1>::compute(PA, PB, p);
        Vec8d e_1 = HermiteECoeff<nA - 1, nB, t>::compute(PA, PB, p);
        Vec8d e_2 = HermiteECoeff<nA - 1, nB, t + 1>::compute(PA, PB, p);
        return 0.5 / p * e_0 + PA * e_1 + Vec8d(t + 1) * e_2;
    }
};
...
> {
    static Vec8d compute(Vec8d PA, Vec8d PB, Vec8d p) {
        // B-side t>0
        // CSE: Cache recursive calls
        Vec8d e_0 = HermiteECoeff<nA, nB - 1, t - 1>::compute(PA, PB, p);
        Vec8d e_1 = HermiteECoeff<nA, nB - 1, t>::compute(PA, PB, p);
        Vec8d e_2 = HermiteECoeff<nA, nB - 1, t + 1>::compute(PA, PB, p);
        return 0.5 / p * e_0 + PB * e_1 + Vec8d(t + 1) * e_2;
    }
};
